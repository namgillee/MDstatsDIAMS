...
params$ionization_dirichet <- c(1, 1, 1)
...
save(boot_consts, boot_out, file =
    "files/ttest/simulation_03/20240711_run01_boot_const_selecton.RData"
)
...
pdf("files/ttest/simulation_03/20240711_run01_selection_of_s0.pdf")
